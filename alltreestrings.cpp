...
// no longer used  extern int pairhasharraysize[]; // = {0,0,51,500,2501,20002,100001,1000001}; // size of array so values generated by pairhash() will all be unique and give no collisions
