...
Gmode3 = 3,  //topology is given, sample genealogies, aka M momde   no model options (no -j)
...
//gextern int lastgenealogysaved;  move to ima_main.cpp
