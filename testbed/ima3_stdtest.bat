...
mpiexec -n 4 ima3_stdtest -i ima3test3pop4loci.u -o ima3_test_mpi_1.out -q1 -m0.1 -t1  -b100000 -L5000 -d200 -r1 -c0 -p4 -hn12 -ha0.97 -hb0.85
mpiexec -n 4 ima3_stdtest -i ima3test3pop4loci.u -o ima3_test_mpi_3.out -q10 -m1 -t1.5 -b100000 -L5000 -d200 -c1  -p23567 -r1245  -hn12 -ha0.97 -hb0.85
mpiexec -n 4 ima3_stdtest -i ima3test3pop4loci.u -o ima3_test_mpi_4.out -q10 -m1 -t1.5 -b100000 -L5000 -d200 -c1  -p3567 -r245 -r3 -fima3_test_mpi_3.out.mcf   -hn12 -ha0.97 -hb0.85
mpiexec -n 4 ima3_stdtest -i ima3test4pop2loci.u -o ima3_test_mpi_26.out  -q10 -m1 -t1.5 -b100000 -L5000  -j013 -r7 -hn8 -ha0.95 -hb0.9
mpiexec -n 4 ima3_stdtest -i ima3test4pop2loci.u -o ima3_test_mpi_27.out  -q10 -m1 -t1.5 -b100000 -L5000  -j013 -r37 -hn8 -ha0.95 -hb0.9 -fima3_test_mpi_26.out
