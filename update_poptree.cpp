...
//extern char **poppairs; // list of all possible poppairs as strings,  declared in initialize.cpp
...
//extern int pairhasharraysize[]; // = {0,0,51,500,2501,20002,100001,1000001}; // size of array so values generated by pairhash() will all be unique and give no collisions
